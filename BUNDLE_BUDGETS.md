...
renderers. Direct A2A, Apollo, standalone GraphQL, and Files uploads remain
isolated in optional entries. Each budget includes an entry's transitive
relative JavaScript imports, so shared normalization code is counted wherever
a consumer needs it. Run
