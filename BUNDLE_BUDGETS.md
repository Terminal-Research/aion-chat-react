...
renderers. Direct A2A and Apollo remain isolated in optional entries. Each
budget includes an entry's transitive relative JavaScript imports, so shared
normalization code is counted wherever a consumer needs it. Run
